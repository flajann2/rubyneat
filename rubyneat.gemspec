...
# -*- encoding: utf-8 -*-
# stub: rubyneat 0.1.8 ruby rnlib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "foo_aquarium_example.rb",
    "rnlib/rubyneat.rb",
    "rnlib/rubyneat/critter.rb",
    "rnlib/rubyneat/default_neat.rb",
    "rnlib/rubyneat/dsl.rb",
    "rnlib/rubyneat/evaluator.rb",
    "rnlib/rubyneat/evolver.rb",
    "rnlib/rubyneat/expressor.rb",
    "rnlib/rubyneat/graph.rb",
    "rnlib/rubyneat/neuron.rb",
    "rnlib/rubyneat/population.rb",
    "rnlib/rubyneat/rubyneat.rb",
    "neater/sigdebug_neat.rb",
    "neater/xor_lib.rb",
    "neater/xor_neat.rb",
    "neater/xordebug_neat.rb",
    ...
    "rubyneat.gemspec",
    "spec/rnlib/rubyneat/rubyneat_spec.rb"
  ]
